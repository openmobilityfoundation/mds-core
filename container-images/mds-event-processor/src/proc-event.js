...
async function checkDupPrevState(device_state, device_last_state) {
...
async function checkOutOfOrder(data, device_state) {
...
async function qualityCheck(data, device_state) {
  /*
