...
describe('Tests Compliance Engine', () => {
  ...
  it('Verifies count compliance violation through exceeding rule maximum', done => {
  ...
  it('Verifies count compliance violation through falling below rule minimum', done => {
