...
import { TEST1_PROVIDER_ID, MOCHA1_PROVIDER_ID } from '@mds-core/mds-providers'
...
const AUTH_BAD_PROVIDER_ONLY = `basic ${Buffer.from(`${MOCHA1_PROVIDER_ID}`).toString('base64')}`
