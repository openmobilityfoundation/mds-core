...
import { StreamSource, StreamSink } from './index'

export const FileSource = <TMessage>(path: string): StreamSource<TMessage> => processor => {
...
export const FileSink = <TMessage>(path: string): StreamSink<TMessage> => () => {
