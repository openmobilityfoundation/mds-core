...
const TABLE_COLUMNS: { [T in TABLE_NAME]: Readonly<COLUMN_NAME[]> } = {
  ...
  [TABLE.geographies]: [COLUMN.id, COLUMN.geography_id, COLUMN.geography_json, COLUMN.published],
  [TABLE.policies]: [COLUMN.id, COLUMN.policy_id, COLUMN.policy_json, COLUMN.published],
...
const COLUMN_TYPE: { [C in COLUMN_NAME]: string } = {
  ...
  [COLUMN.mfgr]: 'varchar(31)',
  [COLUMN.model]: 'varchar(31)',
